var app = (function () {
    ...
    /* src/Table.svelte generated by Svelte v3.35.0 */
    ...
    // (49:4) {#each materials as material (material.id)}
    ...
    function create_fragment$2(ctx) {
    	...
    	let t7;
    	let td1;
    	let t8_value = /*formatter*/ ctx[2].format(/*totalCost*/ ctx[1]) + "";
    	let t8;
      ...
      <th></th></tr>`;
    		...
    		p(ctx, [dirty]) {
    			...
    			if (dirty & /*totalCost*/ 2 && t8_value !== (t8_value = /*formatter*/ ctx[2].format(/*totalCost*/ ctx[1]) + "")) set_data(t8, t8_value);
    		},
    		i: noop,
    		o: noop,
    		d(detaching) {
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*materials*/ 1) {
    			$$invalidate(1, totalCost = materials.reduce((acc, { price }) => acc += price, 0));
    		}
    	};

    	return [materials, totalCost, formatter, edit, remove];
    }
    ...
    /* src/Form.svelte generated by Svelte v3.35.0 */
    ...
    function create_if_block(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(button, "class", "float-right svelte-yrj7k1");
